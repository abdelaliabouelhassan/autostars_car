...
@section('content')
    ...
    @else
        ...
        <div class="col-md-9 col-sm-8">
            <h3><strong>Les Messages</strong></h3>
            ...
            <div class="messages-list">
                    ...
                    <div class="message-item" id="{{'message_item_'.$message->id}}">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="message_item_dropdown_">
                                {{-- archive btn --}}
                                <li class="archive"><a data-toggle="modal" data-target="{{'#archiveModal_'.$message->id}}">Archiver</a></li>
                                {{-- delete btn --}}
                                <li class="delete"><a data-toggle="modal" data-target="{{'#deleteModal_'.$message->id}}">Supprimer</a></li>
                            </ul>
                        </div>
                    </div>

                    {{-- archive modal --}}
                    <div class="modal fade" id="{{'archiveModal_'.$message->id}}" tabindex="-1" role="dialog"  aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h4 class="text-center">Confirmer l'archivation de message</h4>
                                    <h4 class="text-center">id: {{$message->id}}</h4>
                                </div>
                                <div class="modal-body">
                                    <button type="button" data-id="{{$message->id}}" data-toggle-modal="{{'#archiveModal_'.$message->id}}" class="btn btn-warning archive">Confirmer</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bulk_btns_container">
                    <a role="button" data-toggle="modal" data-target="#bulkArchiveModal" class="btn btn-warning btn-sm" >Archiver la sélection</a>
                    {{-- bulk archive modal --}}
                    <div class="modal fade" id="bulkArchiveModal"  role="dialog"  aria-hidden="true">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                ...
                                <div class="modal-body">
                                    <button type="button" id="bulk_archive" class="btn btn-warning bulk_archive">Confirmer</button>
                                </div>
                            </div>
                        </div>
                    </div>
