...
@section('title','dashboard - Voitures')
...
@section('content')
    ...
    @else
        ...
        <div class="col-md-9 col-sm-8">
            <h3><strong> Voiture publiées</strong></h3>
            <div class="dashboard-block">
                            ...
                            @foreach($voitures as $voiture)
                                <tr id="{{'table_row_'.$voiture->id}}">
                                    ...
                                    <td align="center">
                                        ...
                                        {{-- archive btn --}}
                                        <a data-toggle="modal" data-target="{{'#archiveModal_'.$voiture->id}}" class="btn action-btn archive">Archiver</a>
                                        {{-- archive modal --}}
                                        <div class="modal fade" id="{{'archiveModal_'.$voiture->id}}" tabindex="-1" role="dialog"  aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                        <h4>Confirmer l'archivation de:</h4>
                                                        <h5>{{$voiture->titre}}</h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <button type="button" data-id="{{$voiture->id}}" data-toggle-modal="{{'#archiveModal_'.$voiture->id}}" class="btn action-btn archive">Confirmer</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <button role="button" data-toggle="modal" data-target="#bulkArchiveModal" class="btn btn-warning btn-sm" >Archiver la sélection</button>
                {{-- bulk archive modal --}}
                <div class="modal fade" id="bulkArchiveModal" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                <h4>Confirmer l'archivation des voiture selectionées</h4>
                            </div>
                            <div class="modal-body">
                                <button type="button" id="bulk_archive" data-toggle-modal="#bulkArchiveModal" class="btn action-btn bulk_archive">Confirmer</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="bulkDeleteModal" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                <h4>Confirmer la suppression des voiture selectionées</h4>
                            </div>
                            <div class="modal-body">
